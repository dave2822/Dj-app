    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
               ...
               <input type="text" placeholder="Search for events or djs" class="w-full border border-gray-300 bg-white rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
                </div>
            </div>
            <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-10">
            <!-- DJ Card -->
            <div class="w-full bg-white rounded-lg overflow-hidden">
                <div class="p-4">
                    <img src="pexels-david-bartus-844928.jpg" alt="DJ Avatar" class="w-16 h-16 rounded-full object-cover">
                ...
                <div class=" p-4 bg-black border-t border-gray-200">
                    <a href="#join-event" class="text-white    rounded-lg">Tap to join</a>
                </div>
            </div>
            <div class="w-full bg-white rounded-lg overflow-hidden">
                <div class="p-4">
        ...
        <button class="w-1/2 bg-black text-white rounded-lg py-3 px-4 mt-8 mb-4 mx-auto">Show More</button>
        </div>    
    </div>
